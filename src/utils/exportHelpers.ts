...
// Función para generar el archivo AdminContext.tsx completo
export function generateAdminContextFile(state: AdminState): string {
...
// Función para generar el archivo CartContext.tsx completo
export function generateCartContextFile(state: AdminState): string {
  return `import React, { createContext, useContext, useReducer, useEffect } from 'react';
...
// Función para generar el archivo CheckoutModal.tsx completo
export function generateCheckoutModalFile(state: AdminState): string {
...
// Función para generar el archivo PriceCard.tsx completo
export function generatePriceCardFile(state: AdminState): string {
...
// Función para generar el archivo NovelasModal.tsx completo
export function generateNovelasModalFile(state: AdminState): string {
...
// Función principal para generar archivos de contexto
export function generateContextFiles(state: AdminState): { [key: string]: string } {
  return {
    'src/context/AdminContext.tsx': generateAdminContextFile(state),
    'src/context/CartContext.tsx': generateCartContextFile(state),
    'src/components/CheckoutModal.tsx': generateCheckoutModalFile(state),
    'src/components/PriceCard.tsx': generatePriceCardFile(state),
    'src/components/NovelasModal.tsx': generateNovelasModalFile(state)
  };
}

// Función para generar archivos de páginas
export function generatePageFiles(): { [key: string]: string } {
  return {
    'src/pages/Home.tsx': `// Home page implementation with current state`,
    'src/pages/Movies.tsx': `// Movies page implementation`,
    'src/pages/TVShows.tsx': `// TV Shows page implementation`,
    'src/pages/Anime.tsx': `// Anime page implementation`,
    'src/pages/Cart.tsx': `// Cart page implementation`,
    'src/pages/AdminPanel.tsx': `// Admin panel implementation`,
    'src/pages/MovieDetail.tsx': `// Movie detail page implementation`,
    'src/pages/TVDetail.tsx': `// TV detail page implementation`,
    'src/pages/Search.tsx': `// Search page implementation`
  };
}

// Función para generar archivos de componentes
export function generateComponentFiles(): { [key: string]: string } {
  return {
    'src/components/Header.tsx': `// Header component implementation`,
    'src/components/MovieCard.tsx': `// Movie card component implementation`,
    'src/components/HeroCarousel.tsx': `// Hero carousel component implementation`,
    ...
    'src/components/CastSection.tsx': `// Cast section component`,
    'src/components/OptimizedImage.tsx': `// Optimized image component`,
    'src/components/CartAnimation.tsx': `// Cart animation component`
  };
}

// Función para generar archivos de servicios
export function generateServiceFiles(): { [key: string]: string } {
  return {
    'src/services/tmdb.ts': `// TMDB service implementation`,
    'src/services/api.ts': `// API service implementation`,
    'src/services/contentSync.ts': `// Content sync service implementation`
  };
}

// Función para generar archivos de utilidades
export function generateUtilityFiles(): { [key: string]: string } {
  return {
    ...
    'src/utils/systemExport.ts': `// System export utilities`
  };
}

// Función para generar archivos de hooks
export function generateHookFiles(): { [key: string]: string } {
  return {
    'src/hooks/useOptimizedContent.ts': `// Optimized content hook`,
    'src/hooks/useContentSync.ts': `// Content sync hook`,
...
// Función principal para generar todos los archivos fuente
export function generateSourceFiles(state: AdminState): { [key: string]: string } {
  return {
    ...generateContextFiles(state),
    ...generatePageFiles(),
